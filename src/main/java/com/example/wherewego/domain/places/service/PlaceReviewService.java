...
public class PlaceReviewService {
    ...
    public PlaceReviewCreateResponseDto createReview(String placeId, PlaceReviewCreateRequestDto requestDto, Long userId) {
     ...
     */
    @Transactional
    private PlaceReviewCreateResponseDto createReviewTransaction(String placeId, PlaceReviewCreateRequestDto requestDto, Long userId) {
        // 1. 중복 리뷰 검증
    ...
    public PagedResponse<PlaceReviewResponseDto> getPlaceReviews(String placeId, int page, int size, Long currentUserId) {
     ...
     */
    public PlaceReviewResponseDto getMyReviewForPlace(String placeId, Long userId) {
        Optional<PlaceReview> reviewOpt = placeReviewRepository.findByUserIdAndPlaceId(userId, placeId);
        return reviewOpt.map(review -> convertToResponseDto(review, userId)).orElse(null);
    }
